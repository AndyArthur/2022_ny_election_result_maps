...
# contest
rsc$findElement(using='xpath', str_c('/html/body/div[4]/div/div/form/table[2]/tbody/tr[1]/td[1]/select/option[8]'))$clickElement()
...
asm <- arcpullr::get_spatial_layer('https://gisservices.its.ny.gov/arcgis/rest/services/NY_2022_Political_District_Boundaries_Based_on_2020_Census/MapServer/3') %>%
...
nys <- main + 
  ...
  labs(title = str_c('<span style="font-size: 60pt">2022 Assembly Races'),
